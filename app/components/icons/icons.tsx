...
// 5. Metin İkonu (Bold A)
export const TextBoldAIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      fill="currentColor"
...
// 6. Font İkonu (Thin A)
export const FontThinAIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      fill="currentColor"
...
// 7. Yazı Karakteri (Script A)
export const ScriptAIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      fill="currentColor"
...
// 9. Yenile / Google G İkonu Benzeri (Refresh/G)
export const RefreshGIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 25" fill="none" className={className}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
// 11. Bilgi (Info Outline)
export const InfoOutlineIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
// 14. Üç Nokta (Dots Vertical)
export const DotsVerticalIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      fill="currentColor"
      fillRule="evenodd"
...
// 19. Ayarlar (Settings / Gear)
export const SettingsIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      d="M8.959 4.529A2.529 2.529 0 0 1 11.488 2h1.221a1.243 1.243 0 0 0 .035.001 2.542 2.542 0 0 1 2.458 2.602c.004.164.05.324.133.467c.289.488.92.65 1.408.36a2.541 2.541 0 0 1 3.464.93l.583 1.011a2.54 2.54 0 0 1-.967 3.386c-.156.09-.286.22-.375.376c-.28.49-.112 1.112.374 1.396a2.528 2.528 0 0 1 .887 3.445l-.614 1.025a2.54 2.54 0 0 1-3.46.926c-.497-.14-1.019 1.034-1.019 1.034a2.54 2.54 0 0 1-2.541 2.524h-1.17a2.54 2.54 0 0 1-2.54-2.536a1.023 1.023 0 0 0-1.4-.37a2.541 2.541 0 0 1-3.442-.993l-.578-.996a2.528 2.528 0 0 1 .938-3.447c-.001-1.803-.93-3.466-.93-3.466l.622-1.024a2.54 2.54 0 0 1 3.46-.923a1.04 1.04 0 0 0 1.04-1.022V4.53Zm6.386.557v.002h-1.173ZM12.078 10.03a1.717 1.717 0 1 0 0 3.434 1.717 1.717 0 0 0 0-3.434Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
// 28. İndir / Download Box
export const DownloadBoxIcon = ({ className, size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const SystemThemeIcon = ({ className, size = 24 }: IconProps) => (
